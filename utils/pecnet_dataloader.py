...
class ngsimDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return hist,fut,neighbors,lat_enc,lon_enc, refPos
    ...
    def collate_fn(self, samples):
        ...
        ref_pos_batch = torch.zeros(len(samples), 2)

        count = 0
        for sampleId,(hist, fut, nbrs, lat_enc, lon_enc, ref_pos) in enumerate(samples):
            ...
            ref_pos_batch[sampleId, :] = torch.from_numpy(ref_pos)
        ...
        return hist_batch, nbrs_batch, mask_batch, lat_enc_batch, lon_enc_batch, fut_batch, op_mask_batch, ref_pos_batch
